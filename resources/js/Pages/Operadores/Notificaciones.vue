...
function filtrar() {
    ...
    router.get('/operador/notificaciones', params, { preserveState: true, replace: true });
}

function marcarLeida(id) {
    router.post(`/operador/notificaciones/${id}/leer`, {}, {
        preserveScroll: true,
    });
}

function marcarTodasLeidas() {
    router.post('/operador/notificaciones/leer-todas', {}, {
        preserveScroll: true,
    });
}
</script>
