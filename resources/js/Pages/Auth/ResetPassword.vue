    ...
    <div class="min-h-screen flex items-center justify-center px-4" style="background: linear-gradient(135deg, #000000, #1a1a1a, #0F0F0F);">
        <div class="w-full max-w-md bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8" style="animation: fadeInUp 0.8s ease-out both;">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-extrabold text-white">Restablecer contraseña</h1>
                <p class="text-sm text-gray-400 mt-1">Ingresa tu nueva contraseña</p>
            </div>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-4">
                    ...
                    <input id="email" type="email" v-model="form.email" required autofocus autocomplete="email" readonly
                        class="w-full px-3.5 py-2.5 rounded-lg text-sm bg-white/10 border border-white/20 text-white/60 cursor-not-allowed transition-all duration-200"
                        style="border-width:1.5px;">
                </div>

                <div class="mb-4">
                    <label class="block text-xs font-semibold text-white/80 mb-1.5" for="password">Nueva contraseña</label>
