<template>
    <AppLayout title="Nuevo Convenio">
        <div class="mb-5">
            ...
            <div class="card-body">
                <form @submit.prevent="submit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="form.nombre" class="input" :class="{ 'border-red-400': form.errors.nombre }" placeholder="Ej: Convenio general">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="form.cobertura" class="input" :class="{ 'border-red-400': form.errors.cobertura }" placeholder="Ej: Zona metropolitana">
                    ...
                    <div class="flex items-center gap-3 pt-4">
                        ...
                        <Link href="/convenios" class="text-sm font-semibold text-gray-500 hover:text-gray-700">Cancelar</Link>
                    </div>
                </form>
            </div>
        </div>
