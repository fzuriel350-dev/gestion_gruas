...
const form = useForm({
    ...
    convenio_aplicado_id: props.cotizacione.convenio_aplicado_id || '',
    distancia_km: props.cotizacione.distancia_km || '',
    tiempo_estimado_minutos: props.cotizacione.tiempo_estimado_minutos || '',
    costo_banderazo: props.cotizacione.costo_banderazo || '',
    costo_km: props.cotizacione.costo_km || '',
    incluye_peajes: props.cotizacione.incluye_peajes || false,
    num_casetas: props.cotizacione.num_casetas || 0,
    costo_aprox_casetas: props.cotizacione.costo_aprox_casetas || 0,
    origen_calle: props.cotizacione.origen_calle || '',
    origen_num_exterior: props.cotizacione.origen_num_exterior || '',
    origen_num_interior: props.cotizacione.origen_num_interior || '',
    origen_colonia: props.cotizacione.origen_colonia || '',
    origen_codigo_postal: props.cotizacione.origen_codigo_postal || '',
    origen_localidad: props.cotizacione.origen_localidad || '',
    origen_municipio: props.cotizacione.origen_municipio || '',
    origen_estado: props.cotizacione.origen_estado || '',
    destino_calle: props.cotizacione.destino_calle || '',
    destino_num_exterior: props.cotizacione.destino_num_exterior || '',
    destino_num_interior: props.cotizacione.destino_num_interior || '',
    destino_colonia: props.cotizacione.destino_colonia || '',
    destino_codigo_postal: props.cotizacione.destino_codigo_postal || '',
    destino_localidad: props.cotizacione.destino_localidad || '',
    destino_municipio: props.cotizacione.destino_municipio || '',
    destino_estado: props.cotizacione.destino_estado || '',
});
